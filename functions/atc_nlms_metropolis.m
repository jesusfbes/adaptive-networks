function [msd_comb, e_comb, c_out, w_out] = ...
    atc_nlms_metropolis(d, u, w0, mu, A, N, Tmax, error_params, is_returned_w)
%ATC_NLMS_METROPO¨LIS Simulates a Diffusion network with ATC with
%metropolis combiners
%
%
% 
%
...
for i=M:Tmax-1
   ...
   [w , c] = static_combine_metropolis(N, M, A, psi, w_prev );
