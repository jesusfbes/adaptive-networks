function [msd_comb, msd_sep, e_comb, c_out, w_out] = ...
    adn_ls(d, u, w0, mu, A, N, L, Tmax, error_params, is_returned_w)
%ADN_LS Simulates a Diffusion network with local estimation ATC and Adaptive Combiners
%
%
...
for i = M:Tmax-1
    ...
    [w, c, P_sum, z_sum, Y_tilde_list, z_list] = update_combine_ls(N, A, psi,...
        w_prev, e_k, Y_kl, y_k, Y_tilde_list, z_list, P_sum, z_sum, i);
    
      
    
    % save results
    msd_sep(:, i) = sum((w0(:, :, i) - psi).^2);
